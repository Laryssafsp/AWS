"""
Esse script recupere os dados do objeto que você fez upload na última tarefa.
Em seguida, ele converte os dados em uma string JSON e cria um novo objeto no bucket d
Amazon S3.

- Leia o arquivo config.ini e use as configurações para todos os valores estáticos.
- getCSVFile baixa o conteúdo do objeto notes.csv como uma string.
- convertToJSON converte a string csv em uma string JSON.
- createObject cria um novo objeto do Amazon S3 com a string convertida para JSON.
"""
